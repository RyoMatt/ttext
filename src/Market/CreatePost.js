...
import { Text, View, Image, ScrollView, StatusBar, StyleSheet, Button, Alert, TouchableOpacity, FlatList, TextInput } from 'react-native';
import { createStackNavigator } from '@react-navigation/stack';
import { Picker } from "@react-native-picker/picker";
import {launchCamera, launchImageLibrary} from 'react-native-image-picker';

//This screen is what allows users to create a post. This information should be sent to the database once it has been established.
//In testing, text fields can be filled out and can press the button "POST" but that information is not saved anywhere. Pressing 
//the 'POST' button will just lead back to the previous page.
